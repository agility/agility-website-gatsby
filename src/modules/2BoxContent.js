...
const BoxContent = ({ item }) => {
  ...
  const classSection = `mod module-chanel 2BoxContent animation ${
  ...
  const classitem =
    ...
    (btnCta2 || image2 || heading2 || description2)
      ? "col-lg-6 item-chanel"
      : "col-lg-8 item-chanel"
  ...
  useEffect(() => {
    const prevElem =
      thisModuleRef.current.previousElementSibling?.previousElementSibling
    if (
      prevElem &&
      typeof prevElem === "object" &&
      prevElem.classList.contains("mod-user-guides")
    ) {
                ...
                <div className="wrap-chanel text-center last-mb-none ps-rv">
                  {btnCta && btnCta.href && (
                    <a
                      ...
                      className="ps-as"
                    >
                      <span className="sr-only">{btnCta.text}</span>
                    </a>
                  )}
                  {image && <AgilityImage image={image} loading="lazy" />}
                  ...
                  {btnCta && btnCta.href && (
                    <p>
                      <a
                        href={btnCta.href}
                        target={btnCta.target}
                        className="link-line line-purple"
                      >
                        {btnCta.text}
                      </a>
                    </p>
                ...
                <div className="wrap-chanel text-center last-mb-none ps-rv">
                  {btnCta2 && btnCta2.href && (
                    <a
                      ...
                      className="ps-as"
                    >
                      <span className="sr-only">{btnCta2.text}</span>
                    </a>
                  )}
                  {image2 && (
                    <AgilityImage
