...
const AgilityPageTemplate = loadable(() =>
  import("./agility/components/AgilityPageTemplate")
)
const PreviewBar = loadable(() => import("./components/PreviewBar"))
const NewGlobalHeader = loadable(() => import("./components/NewGlobalHeader"))
const NewGlobalFooter = loadable(() => import("./components/NewGlobalFooter"))
